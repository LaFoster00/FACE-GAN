...
from layers import pixel_norm, EqualizedDense, EqualizedConv, fade_in, AdaIN, AddNoise
...
def Mapping(num_stages, input_shape=512):
    ...
    return models.Model(inputs=z, outputs=w, name="mapping")
...
class Generator:
    ...
    def build_block(self, filter_num, res, input_shape, is_base):
        ...
        x = layers.GroupNormalization(groups=-1)(x)
        x = AdaIN()([x, w])
        return models.Model([input_tensor, w, noise], x, name=f"genblock_{res}x{res}")
